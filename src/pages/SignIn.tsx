...
export default function SignIn({ onNavigate, onAuthenticated, navData }: SignInProps) {
  ...
  return <div className="min-h-screen bg-white flex flex-col items-center justify-center px-5 py-16"><div className="w-full max-w-sm">
    <div className="text-center mb-8"><span className="font-serif text-2xl text-teal-600">Saarthi</span><p className="text-sm text-gray-500 mt-2">{stage === "otp" ? "Confirm your mobile number" : mode === "signin" ? "Sign in to continue your journey" : "Create an account to get started"}</p></div>
    {stage === "mobile" ? <>
